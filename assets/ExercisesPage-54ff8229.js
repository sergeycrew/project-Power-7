import{u as l,J as B,a as P,b as j,j as r,T as oe,U as z,r as d,V as N,F as se,W as Y,X as ae,Y as le,R as T,i as L,Z as ce,_ as de,L as pe,$ as he,a0 as ue,a1 as fe,C as xe}from"./index-b51feb05.js";import{D as me}from"./DiaryLoader-3466e1f7.js";import{e as ge}from"./UserForm.styled-01cf911b.js";import{T as we,_ as M,C as q,a as be,M as ve,b as ye,B as je}from"./ExercisesList.styled-ffd97116.js";import"./formik.esm-17ede76a.js";const Ee=l.div`
  max-width: 1440px;
  margin-bottom: 40px;
...
`,X=t=>t.exercises.loading,J=t=>t.exercises.filter,Ce=t=>t.exercises.exercises,Le=t=>t.exercises.categories,_=t=>t.exercises.categoryPicked,De=t=>t.exercises.maxPage,Pe=t=>t.exercises.exercisesPage,K=B([J,Le,X],(t,i,n)=>{if(!n)return i.filter(e=>(e==null?void 0:e.filter)===t)}),Z=t=>t.exercises.categoriesPage,ee=t=>t.exercises.categoriesLimit,_e=B([K,Z,ee],(t,i,n)=>{let e=[];return(t==null?void 0:t.length)>0&&(e=t.slice((i-1)*n,i*n)),e}),$e=B([K,ee],(t,i)=>{let n=[];const e=Math.ceil((t==null?void 0:t.length)/i);if(e>1){for(let o=1;o<=e;o++)n.push(o);return n}}),Me=()=>{const t=P(),i=j(J),n=j(_),e=o=>{t(oe(o)),t(z(""))};return r.jsxs(Ee,{children:[n?r.jsx(Te,{children:n}):r.jsx(ke,{children:"Exercises"}),r.jsxs(Se,{children:[r.jsx(R,{type:"button",onClick:()=>e("Body parts"),theme:{kostil:i==="Body parts"?void 0:"true"},children:"Body parts"}),r.jsx(R,{type:"button",onClick:()=>e("Muscles"),theme:{kostil:i==="Muscles"?void 0:"true"},children:"Muscles"}),r.jsx(R,{type:"button",onClick:()=>e("Equipment"),theme:{kostil:i==="Equipment"?void 0:"true"},children:"Equipment"})]})]})},Re=l.div`
padding-top: 40px;
padding-bottom: 80px;
...
`,Nt=({children:t})=>{const i=j(_);return r.jsx(Gt,{theme:{activeCategory:i},children:t})},en=()=>{const t=j(_);return r.jsx(Nt,{children:r.jsx(xe,{children:r.jsxs(Re,{children:[r.jsx(Me,{}),t?r.jsx(Ht,{}):r.jsx(Ke,{})]})})})};export{en as default};
