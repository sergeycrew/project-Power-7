...
`,eo=E.div`
  ...
  width: 100%;
  gap: ${n=>n.theme.spacing(4)};
`,Fe="#1c1c1c",le="#efede8",to="rgba(239, 237, 232, 0.1)",ot={option:n=>({...n,background:Fe,color:le,textwrap:"nowrap"}),control:n=>({...n,backgroundColor:"transparent",borderRadius:"12px",width:"100%",height:"46px",border:"1px solid rgba(239, 237, 232, 0.2)",boxShadow:"none","&:hover":{borderColor:"#E6533C"},"&:focus":{borderColor:"#E6533C"},"@media (min-width: 768px)":{height:"50px"}}),dropdownIndicator:n=>({...n,display:"none","@media (min-width: 768px)":{display:"flex",justifyContent:"flex-end",color:le}}),menu:n=>({...n,background:Fe,borderRadius:"12px"}),menuList:n=>({...n,"::-webkit-scrollbar":{width:"22px"},"::-webkit-scrollbar-track":{background:"transparent"},"::-webkit-scrollbar-thumb":{background:to,borderRadius:"12px",border:"7px solid",borderColor:Fe},maxHeight:"276px",borderRadius:"12px",overflowX:"hidden"}),indicatorSeparator:n=>({...n,display:"none"}),placeholder:n=>({...n,color:le}),singleValue:n=>({...n,color:le}),container:n=>({...n,display:"flex",alignItems:"center",border:"1px",height:"46px",width:"100%","&:hover":{borderColor:"#E6533C"},"&:focus":{borderColor:"#E6533C"},"@media (min-width: 768px)":{height:"50px"}}),input:n=>({...n,fontSize:"14px"})},at=[{value:"",label:"All"},{value:"recommended",label:"Recommended"},{value:"not recommended",label:"Not recommended"}],no=()=>{const n=ve(),e=Q(ln),i=Zt({initialValues:{title:"",category:"",type:""},validate:l=>{l.title&&l.title.length<2},onSubmit:l=>a(l)}),t=(l,o)=>l?l.find(s=>s.value==o):"",a=l=>{n(Wt(l)),n(dt()),n(Me())},u=(l,o)=>{i.setFieldValue(l,o.value);const{initialValues:s,values:c}=i;if(o.value!==s[o.value]){const d={...c,[l]:o.value};a(d)}};return h.jsxs(Yi,{onSubmit:i.handleSubmit,children:[h.jsx(qi,{type:"text",name:"title",placeholder:"Search",value:i.values.title.trim(),onChange:i.handleChange}),i.values.title.trim()!==""&&h.jsx(Ki,{type:"button",onClick:()=>{i.setFieldValue("title",""),a("title")},children:h.jsx(Ji,{children:h.jsx("use",{href:`${de}#icon-x`})})}),h.jsx(Zi,{type:"submit",children:h.jsx(Qi,{children:h.jsx("use",{href:`${de}#icon-search`})})}),h.jsxs(eo,{children:[h.jsx(it,{value:t(e,i.values.category),onChange:l=>u("category",l),options:e,placeholder:"Categories",styles:ot}),h.jsx(it,{value:t(at,i.values.type),onChange:l=>u("type",l),options:at,styles:ot})]}),h.jsx(Xi,{children:"Filters"})]})},ro=n=>n.$recommended?n.theme.colors.recommendedColor:n.theme.colors.notRecommendedColor,io=E.div`
  height: 141px;
...
`,mo=({product:{_id:n,title:e,calories:r,category:i,weight:t,recommended:a=!0},toggleModal:u})=>h.jsxs(io,{children:[h.jsxs(oo,{children:[h.jsx(ao,{children:"diet"}),h.jsx(uo,{$recommended:a}),h.jsx(ut,{children:h.jsx("b",{children:a?"Recommended":"Not recommended"})}),h.jsxs(so,{onClick:()=>u({_id:n,title:e,calories:r,category:i,weight:t}),children:["Add",h.jsx(lo,{children:h.jsx("use",{href:`${de}#icon-arrow-right`})})]})]}),h.jsxs(co,{children:[h.jsx(fo,{children:h.jsx("use",{href:`${de}#icon-run-exercises`})}),h.jsx(po,{children:e})]}),h.jsxs(ho,{children:[h.jsxs(we,{children:[h.jsx(Oe,{children:"Calories:"})," ",h.jsx(st,{children:r})]}),h.jsxs(we,{children:[h.jsx(Oe,{children:"Category: "})," ",h.jsx(ut,{children:i})]}),h.jsxs(we,{children:[h.jsx(Oe,{children:"Weight:"})," ",h.jsx(st,{children:t})]})]})]}),vo=E.ul`
  display: flex;
  justify-content: center;
  flex-wrap: wrap;
  color: #efede8;
...
`,Mo=({onToggle:n,exerciseInfo:e,setIsSuccessOpen:r,setDairyProduct:i})=>{console.log(e);const t=ve(),{weight:a,calories:u,_id:l,title:o}=e,[s,c]=p.useState(a),d=Math.round(s*u/100),m=()=>{if(!d)return;const v={productId:l,amount:s,calories:d};console.log(v),t(Gt(v)),i({calories:v.calories}),r(),n()};return h.jsx(bo,{modalStyles:{maxWidth:"479px",width:"100%",height:"280px"},modalTabletStyles:{width:"479",height:"291px"},modalDesktopStyles:{width:"479px",height:"286px"},onClose:n,children:h.jsxs(xo,{children:[h.jsxs(Eo,{children:[h.jsx(Co,{type:"text",value:o,readOnly:!0,disabled:!0}),h.jsxs(So,{children:[h.jsx(yo,{type:"number",value:s,onChange:v=>{c(v.target.value)}}),h.jsx(Fo,{children:"grams"})]})]}),h.jsxs(Io,{children:[h.jsx(wo,{children:"Calories:"}),h.jsx(Oo,{children:d})]}),h.jsxs(Do,{children:[h.jsx(Po,{onClick:m,children:"Add to diary"}),h.jsx(Ao,{onClick:n,children:"Cancel"})]})]})})},Vo="/project-Power-7/assets/avocado-1x-2290870f.png",Lo=E(pt)`
...
`,Uo=({calories:n,onClose:e})=>h.jsx(Lo,{modalStyles:{maxWidth:"430px",width:"100%",height:"384px"},modalTabletStyles:{width:"430px",height:"439px"},modalDesktopStyles:{width:"430px",height:"439px"},onClose:e,children:h.jsxs(To,{children:[h.jsx(ko,{src:Vo,alt:"Category Image"}),h.jsxs(Bo,{children:[h.jsx($o,{children:"Well done"}),h.jsx("ul",{children:h.jsxs(jo,{children:["Calories:",h.jsx(Ho,{children:n||0})]})})]}),h.jsx(_o,{children:h.jsx(Ro,{onClick:e,children:"Next product "})}),h.jsxs(zo,{to:"/diary",children:["To the diary",h.jsx("svg",{width:" 16px",height:"16px",children:h.jsx("use",{href:`${Xt}#arrow_gray`})})]})]})}),No=()=>{const n=ve(),e=Q(ft),r=Q(ht),[i,t]=p.useState(!1),[a,u]=p.useState(!1),[l,o]=p.useState(null),[s,c]=p.useState({calories:0}),d=Q(cn),m=Q(dn),v=()=>{n(qt(1)),n(Me())},x=g=>{t(f=>!f),o(g)};return h.jsxs("div",{children:[h.jsxs(vo,{children:[e.map(g=>h.jsx(go,{children:h.jsx(mo,{product:g,toggleModal:x})},g._id)),!r&&d!==m&&h.jsx(rn,{type:"button",onClick:()=>v(),children:"Load More"})]}),i&&h.jsx(Mo,{onToggle:x,setIsSuccessOpen:()=>u(g=>!g),exerciseInfo:l,setDairyProduct:c}),a&&h.jsx(Uo,{onClose:()=>u(g=>!g),calories:s.calories})]})},Wo=E.div`
  display: flex;
  flex-direction: column;
  gap: 16px;
...
`,ct=E.span`
  color: ${n=>n.theme.colors.orangeColor};
`,Go=()=>h.jsxs(Wo,{children:[h.jsxs(lt,{children:[h.jsx(ct,{children:"Sorry, no results were found "}),"for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),h.jsx(lt,{children:h.jsx(ct,{children:"Try changing the search parameters."})})]}),Yo=E.div`
  display: flex;
  justify-content: space-between;
  flex-direction: column;
...
`,Ko=({children:n})=>h.jsx(qo,{children:n}),ra=()=>{const n=ve(),e=Q(pn),r=Q(ht);return p.useEffect(()=>{n(Kt()),n(dt()),n(Me())},[n]),h.jsx(Ko,{children:h.jsxs(Jt,{children:[h.jsxs(Yo,{children:[h.jsx(Xo,{children:"Products"}),h.jsx(no,{})]}),r?h.jsx(an,{}):e?h.jsx(No,{}):h.jsx(Go,{})]})})};export{ra as default};
