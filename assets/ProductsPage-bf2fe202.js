...
`;i.img`
  ...
  height: 40px;
  object-fit: cover;
`;const oe=()=>{const e=g();p(S);const o=p(C);return j.useEffect(()=>{e(u())},[e]),t.jsxs(U,{children:[t.jsxs(Z,{children:[t.jsx(ee,{children:"Products"}),t.jsx(A,{})]}),o?t.jsx(J,{}):t.jsx(Q,{})]})};export{oe as default};
