...
`,Cr=document.querySelector("#modal-root"),Or=({onClose:e,children:r,modalStyles:t,modalTabletStyles:n,modalDesktopStyles:i,modal320Styles:a})=>{const s=window.scrollY,o=c=>{c.currentTarget===c.target&&e()};return R.useEffect(()=>{const c=h=>{h.code==="Escape"&&e()};return document.body.style.position="fixed",document.body.style.width="100%",document.body.style.top=`-${s}px`,window.addEventListener("keydown",c),()=>{window.removeEventListener("keydown",c),document.body.style.position="",window.scrollTo(0,s),document.body.style.top="",document.body.style.width=""}},[e,s]),$e.createPortal(I.jsx(yr,{onClick:o,children:I.jsxs(vr,{theme:{modal320Styles:a,modalStyles:t,modalTabletStyles:n,modalDesktopStyles:i},children:[I.jsx(kr,{type:"button",onClick:e,children:I.jsx("svg",{width:"20",height:"20",stroke:"white",children:I.jsx("use",{href:Ae+"#x"})})}),r]})}),Cr)},Tr=b.button`
...
`;const Er=b.div`
  ...
  ${e=>e.theme.position}
  @media screen and (min-width: 768px) {
    ${e=>e.theme.positionTablet}
  }
  @media screen and (min-width: 1440px) {
    ${e=>e.theme.positionPc}
  }
`,Nr=({position:e,positionTablet:r,positionPc:t})=>I.jsx(Er,{theme:{position:e,positionTablet:r,positionPc:t},children:I.jsx(Oe,{color:"#ef8964",visible:!0,height:200,width:200,ariaLabel:"infinity-spin-loading"})});export{Rr as B,Or as C,Ar as E,Nr as L,Pr as M,gr as T,oe as _,Tr as a,Mr as b,$r as c,Ce as h,hr as s};
