...
`,Xo=({children:n})=>h.jsx(Ko,{children:n}),ta=()=>{const n=ve(),e=Q(pn);return p.useEffect(()=>{n(Xt()),n(dt()),n(Me())},[n]),h.jsx(Xo,{children:h.jsx(Go,{children:h.jsxs(Zt,{children:[h.jsxs(Yo,{children:[h.jsx(qo,{children:"Products"}),h.jsx(no,{})]}),e?h.jsx(Uo,{}):h.jsx(Wo,{})]})})})};export{ta as default};
