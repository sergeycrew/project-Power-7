...
`,so=({product:{_id:n,title:e,calories:r,category:i,weight:t,recommended:a=!0},toggleModal:u})=>f.jsxs(Zi,{children:[f.jsxs(Qi,{children:[f.jsx(eo,{children:"diet"}),f.jsx(to,{$recommended:a}),f.jsx(at,{children:f.jsx("b",{children:a?"Recommended":"Not recommended"})}),f.jsxs(no,{onClick:()=>u({_id:n,title:e,calories:r,category:i,weight:t}),children:["Add",f.jsx(ro,{children:f.jsx("use",{href:`${de}#icon-arrow-right`})})]})]}),f.jsxs(io,{children:[f.jsx(ao,{children:f.jsx("use",{href:`${de}#icon-run-exercises`})}),f.jsx(oo,{children:e})]}),f.jsxs(uo,{children:[f.jsxs(we,{children:[f.jsx(Fe,{children:"Calories:"})," ",f.jsx(ut,{children:r})]}),f.jsxs(we,{children:[f.jsx(Fe,{children:"Category: "})," ",f.jsx(at,{children:i})]}),f.jsxs(we,{children:[f.jsx(Fe,{children:"Weight:"})," ",f.jsx(ut,{children:t})]})]})]}),lo=E.ul`
  display: flex;
  flex-wrap: wrap;
  color: #efede8;
  row-gap: 32px;
...
`,Wo=({children:n})=>f.jsx(No,{children:n}),Jo=()=>{const n=Ae(),e=ce(an);return p.useEffect(()=>{n(Xt()),n(ct())},[n]),f.jsx(Wo,{children:f.jsxs(_o,{children:[f.jsxs(zo,{children:[f.jsx(Uo,{children:"Products"}),f.jsx(Ki,{})]}),e?f.jsx(Bo,{}):f.jsx(Ho,{})]})})};export{Jo as default};
