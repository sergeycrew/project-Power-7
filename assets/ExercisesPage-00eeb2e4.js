import{u as l,I as z,a as D,b as j,j as r,Q as se,S as F,r as d,T as q,R as ae,U as O,V as le,W as ce,E as T,s as R,X as de,Y as pe,L as he,Z as ue,_ as fe,$ as xe,C as me}from"./index-d9b6e445.js";import{D as ge}from"./DiaryLoader-46ff382c.js";import{e as we}from"./UserForm.styled-0ef5e62e.js";import{T as be,_ as $,C as X,a as ve,M as ye,b as je,B as Ee}from"./ExercisesList.styled-60e6a0eb.js";import{i as I}from"./sprite-4040c2ad.js";import"./formik.esm-e9ed6f0e.js";const Se=l.div`
  max-width: 1440px;
  margin-bottom: 40px;
...
`,K=t=>t.exercises.loading,Z=t=>t.exercises.filter,Le=t=>t.exercises.exercises,De=t=>t.exercises.categories,P=t=>t.exercises.categoryPicked,Pe=t=>t.exercises.maxPage,_e=t=>t.exercises.exercisesPage,J=z([Z,De,K],(t,i,n)=>{if(!n)return i.filter(e=>(e==null?void 0:e.filter)===t)}),ee=t=>t.exercises.categoriesPage,te=t=>t.exercises.categoriesLimit,$e=z([J,ee,te],(t,i,n)=>{let e=[];return(t==null?void 0:t.length)>0&&(e=t.slice((i-1)*n,i*n)),e}),Me=z([J,te],(t,i)=>{let n=[];const e=Math.ceil((t==null?void 0:t.length)/i);if(e>1){for(let o=1;o<=e;o++)n.push(o);return n}}),Re=()=>{const t=D(),i=j(Z),n=j(P),e=o=>{t(se(o)),t(F(""))};return r.jsxs(Se,{children:[n?r.jsx(ke,{children:n}):r.jsx(Ce,{children:"Exercises"}),r.jsxs(Te,{children:[r.jsx(M,{type:"button",onClick:()=>e("Body parts"),theme:{kostil:i==="Body parts"?void 0:"true"},children:"Body parts"}),r.jsx(M,{type:"button",onClick:()=>e("Muscles"),theme:{kostil:i==="Muscles"?void 0:"true"},children:"Muscles"}),r.jsx(M,{type:"button",onClick:()=>e("Equipment"),theme:{kostil:i==="Equipment"?void 0:"true"},children:"Equipment"})]})]})},Ie=l.div`
padding-top: 40px;
padding-bottom: 80px;
...
`,W=l.div`
  ...
  justify-content: center;
  align-items: center;
`;var A=typeof window>"u"?d.useEffect:d.useLayoutEffect,mt=({isPlaying:t,duration:i,startAt:n=0,updateInterval:e=0,onComplete:o,onUpdate:s})=>{let[a,c]=d.useState(n),h=d.useRef(0),p=d.useRef(n),x=d.useRef(n*-1e3),u=d.useRef(null),m=d.useRef(null),b=d.useRef(null),y=g=>{let v=g/1e3;if(m.current===null){m.current=v,u.current=requestAnimationFrame(y);return}let f=v-m.current,w=h.current+f;m.current=v,h.current=w;let k=p.current+(e===0?w:(w/e|0)*e),_=p.current+w,Y=typeof i=="number"&&_>=i;c(Y?i:k),Y||(u.current=requestAnimationFrame(y))},E=()=>{u.current&&cancelAnimationFrame(u.current),b.current&&clearTimeout(b.current),m.current=null},S=d.useCallback(g=>{E(),h.current=0;let v=typeof g=="number"?g:n;p.current=v,c(v),t&&(u.current=requestAnimationFrame(y))},[t,n]);return A(()=>{if(s==null||s(a),i&&a>=i){x.current+=i*1e3;let{shouldRepeat:g=!1,delay:v=0,newStartAt:f}=(o==null?void 0:o(x.current/1e3))||{};g&&(b.current=setTimeout(()=>S(f),v*1e3))}},[a,i]),A(()=>(t&&(u.current=requestAnimationFrame(y)),E),[t,i,e]),{elapsedTime:a,reset:S}},gt=(t,i,n)=>{let e=t/2,o=i/2,s=e-o,a=2*s,c=n==="clockwise"?"1,0":"0,1",h=2*Math.PI*s;return{path:`m ${e},${o} a ${s},${s} 0 ${c} 0,${a} a ${s},${s} 0 ${c} 0,-${a}`,pathLength:h}},U=(t,i)=>t===0||t===i?0:typeof i=="number"?t-i:0,wt=t=>({position:"relative",width:t,height:t}),bt={display:"flex",justifyContent:"center",alignItems:"center",position:"absolute",left:0,top:0,width:"100%",height:"100%"},re=(t,i,n,e,o)=>{if(e===0)return i;let s=(o?e-t:t)/e;return i+n*s},H=t=>{var i,n;return(n=(i=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,(e,o,s,a)=>`#${o}${o}${s}${s}${a}${a}`).substring(1).match(/.{2}/g))==null?void 0:i.map(e=>parseInt(e,16)))!=null?n:[]},vt=(t,i)=>{var n;let{colors:e,colorsTime:o,isSmoothColorTransition:s=!0}=t;if(typeof e=="string")return e;let a=(n=o==null?void 0:o.findIndex((m,b)=>m>=i&&i>=o[b+1]))!=null?n:-1;if(!o||a===-1)return e[0];if(!s)return e[a];let c=o[a]-i,h=o[a]-o[a+1],p=H(e[a]),x=H(e[a+1]),u=!!t.isGrowing;return`rgb(${p.map((m,b)=>re(c,m,x[b]-m,h,u)|0).join(",")})`},yt=t=>{let{duration:i,initialRemainingTime:n,updateInterval:e,size:o=180,strokeWidth:s=12,trailStrokeWidth:a,isPlaying:c=!1,isGrowing:h=!1,rotation:p="clockwise",onComplete:x,onUpdate:u}=t,m=d.useRef(),b=Math.max(s,a??0),{path:y,pathLength:E}=gt(o,b,p),{elapsedTime:S}=mt({isPlaying:c,duration:i,startAt:U(i,n),updateInterval:e,onUpdate:typeof u=="function"?v=>{let f=Math.ceil(i-v);f!==m.current&&(m.current=f,u(f))}:void 0,onComplete:typeof x=="function"?v=>{var f;let{shouldRepeat:w,delay:k,newInitialRemainingTime:_}=(f=x(v))!=null?f:{};if(w)return{shouldRepeat:w,delay:k,newStartAt:U(i,_)}}:void 0}),g=i-S;return{elapsedTime:S,path:y,pathLength:E,remainingTime:Math.ceil(g),rotation:p,size:o,stroke:vt(t,g),strokeDashoffset:re(S,0,E,i,h),strokeWidth:s}},oe=t=>{let{children:i,strokeLinecap:n,trailColor:e,trailStrokeWidth:o}=t,{path:s,pathLength:a,stroke:c,strokeDashoffset:h,remainingTime:p,elapsedTime:x,size:u,strokeWidth:m}=yt(t);return T.createElement("div",{style:wt(u)},T.createElement("svg",{viewBox:`0 0 ${u} ${u}`,width:u,height:u,xmlns:"http://www.w3.org/2000/svg"},T.createElement("path",{d:s,fill:"none",stroke:e??"#d9d9d9",strokeWidth:o??m}),T.createElement("path",{d:s,fill:"none",stroke:c,strokeLinecap:n??"round",strokeWidth:m,strokeDasharray:a,strokeDashoffset:h})),typeof i=="function"&&T.createElement("div",{style:bt},i({remainingTime:p,elapsedTime:x,color:c})))};oe.displayName="CountdownCircleTimer";const jt=({onToogle:t,exerciseInfo:i,setIsSuccessOpen:n,setWorkoutDoneInfo:e})=>{const o=i.time*60,[s,a]=d.useState(!1),[c,h]=d.useState(0),[p,x]=d.useState(0),[u,m]=d.useState(o),b=D();function y(f){const w=Math.floor(f/60),k=f%60;return`${w}:${k<10?"0":""}${k}`}const E=Math.round(i.burnedCalories/o*100)/100;d.useEffect(()=>{let f;return s&&u!==c?f=setInterval(()=>{h(w=>w+1),x(w=>w+E)},1e3):c===u&&(a(!1),m(w=>w+o)),()=>clearInterval(f)},[o,a,h,s,c,x,E,u]);const S=()=>{a(f=>!f)},g=y(c),v=()=>{if(s||c<1){de.error("Impossible to add workout. Finish working out before adding!");return}const f={exerciseId:i._id,time:Math.ceil(c/60),calories:Math.ceil(p)};b(pe(f)),e({time:f.time,calories:f.calories}),n(),t(),console.log(f)};return r.jsx(X,{onClose:t,modalStyles:{width:"335px",height:"858px",flexDirection:"column",alignItems:"center",display:"flex",padding:"0"},modalTabletStyles:{width:"694px",height:"550px",display:"flex",flexDirection:"inherit",gap:"16px",margin:"0px",alignItems:"flex-start"},children:r.jsxs(r.Fragment,{children:[r.jsxs(W,{children:[r.jsx(tt,{children:r.jsx(et,{src:i.gifUrl,alt:"Working out"})}),r.jsxs(nt,{children:[r.jsx(ot,{children:"Time"}),r.jsx(oe,{isPlaying:s,duration:o,size:125,colors:"#E6533C",trailColor:"#EFEDE81A",strokeWidth:4,onComplete:()=>{if(s)return{shouldRepeat:!0}},children:()=>r.jsx("div",{style:{display:"flex",flexDirection:"column",color:"white"},children:r.jsx("div",{children:g})})})]}),r.jsx(it,{type:"button",onClick:S,children:r.jsx(rt,{children:s?r.jsx("use",{href:`${R}#pause-square`}):r.jsx("use",{href:`${R}#play`})})}),r.jsxs(pt,{children:[r.jsx(ht,{children:"Burned calories:"}),r.jsx(ut,{children:Math.round(p*100)/100})]})]}),r.jsxs(W,{children:[r.jsx(lt,{children:Object.entries(i).filter(([f,w])=>f!=="gifUrl"&&f!=="burnedCalories"&&f!=="_id").map(([f,w])=>r.jsx(dt,{children:r.jsxs(ct,{children:[r.jsx(st,{children:f}),r.jsx(at,{children:w})]})},w))}),r.jsx(ft,{onClick:v,children:r.jsx(xt,{children:"Add to diary"})})]})]})})},Et="/project-Power-7/assets/thumb-up-1x-575f03e5.png",St=l(X)`
...
`,qt=({children:t})=>{const i=j(P);return r.jsx(Nt,{theme:{activeCategory:i},children:t})},nn=()=>{const t=j(P);return r.jsx(qt,{children:r.jsx(me,{children:r.jsxs(Ie,{children:[r.jsx(Re,{}),t?r.jsx(Qt,{}):r.jsx(Je,{})]})})})};export{nn as default};
