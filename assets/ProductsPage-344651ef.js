...
`,mo=({product:{_id:n,title:e,calories:r,category:i,weight:t,recommended:a=!0},toggleModal:u})=>f.jsxs(io,{children:[f.jsxs(oo,{children:[f.jsx(ao,{children:"diet"}),f.jsx(uo,{$recommended:a}),f.jsx(st,{children:f.jsx("b",{children:a?"Recommended":"Not recommended"})}),f.jsxs(so,{onClick:()=>u({_id:n,title:e,calories:r,category:i,weight:t}),children:["Add",f.jsx(lo,{children:f.jsx("use",{href:`${ie}#icon-arrow`})})]})]}),f.jsxs(co,{children:[f.jsx(fo,{children:f.jsx("use",{href:`${ie}#icon-icon`})}),f.jsx(po,{children:e})]}),f.jsxs(ho,{children:[f.jsxs(we,{children:[f.jsx(Oe,{children:"Calories:"})," ",f.jsx(lt,{children:r})]}),f.jsxs(we,{children:[f.jsx(Oe,{children:"Category: "})," ",f.jsx(st,{children:i})]}),f.jsxs(we,{children:[f.jsx(Oe,{children:"Weight:"})," ",f.jsx(lt,{children:t})]})]})]}),go=E.ul`
  display: flex;
  justify-content: center;
  flex-wrap: wrap;
  color: #efede8;
...
`,Mo=({onToggle:n,exerciseInfo:e,setIsSuccessOpen:r,setDairyProduct:i})=>{const t=ge(),{weight:a,calories:u,_id:l,title:o}=e,[s,c]=p.useState(a),d=Math.round(s*u/100),v=Y(mt).filter(m=>m.value===e.category)[0].img;t(Yt(v));const b=()=>{if(!d)return;const m={productId:l,amount:s,calories:d};t(qt(m)),i({calories:m.calories}),r(),n()};return f.jsx(bo,{modalStyles:{width:"335px"},modalTabletStyles:{width:"479px"},modalDesktopStyles:{width:"479px"},onClose:n,children:f.jsxs(xo,{children:[f.jsxs(Eo,{children:[f.jsx(Co,{type:"text",value:o,readOnly:!0,disabled:!0}),f.jsxs(So,{children:[f.jsx(yo,{type:"number",value:s,onChange:m=>{c(m.target.value)}}),f.jsx(Fo,{children:"grams"})]})]}),f.jsxs(Io,{children:[f.jsx(wo,{children:"Calories:"}),f.jsx(Oo,{children:d})]}),f.jsxs(Do,{children:[f.jsx(Po,{onClick:b,children:"Add to diary"}),f.jsx(Ao,{onClick:n,children:"Cancel"})]})]})})},Vo=E(ft)`
...
`,zo=({calories:n,onClose:e})=>{const r=Y(cn);return f.jsx(Vo,{modalStyles:{maxWidth:"430px",width:"100%",height:"384px"},modalTabletStyles:{width:"430px",height:"439px"},modalDesktopStyles:{width:"430px",height:"439px"},onClose:e,children:f.jsxs(ko,{children:[f.jsx(Ro,{src:r,alt:"Category Image"}),f.jsxs($o,{children:[f.jsx(To,{children:"Well done"}),f.jsx("ul",{children:f.jsxs(Bo,{children:["Calories:",f.jsx(jo,{children:n||0})]})})]}),f.jsx(Ho,{children:f.jsx(Lo,{onClick:e,children:"Next product "})}),f.jsxs(_o,{to:"/diary",children:["To the diary",f.jsx("svg",{width:" 16px",height:"16px",children:f.jsx("use",{href:`${ie}#arrow_gray`})})]})]})})},Uo=()=>{const n=ge(),e=Y(Ve),r=Y(ht),[i,t]=p.useState(!1),[a,u]=p.useState(!1),[l,o]=p.useState(null),[s,c]=p.useState({calories:0}),d=Y(dn),g=Y(pn),v=()=>{n(Xt(1)),n(Me())},b=m=>{t(h=>!h),o(m)};return f.jsxs("div",{children:[f.jsxs(go,{children:[e.map(m=>f.jsx(vo,{children:f.jsx(mo,{product:m,toggleModal:b})},m._id)),!r&&d!==g&&f.jsx(on,{type:"button",onClick:()=>v(),children:"Load More"})]}),i&&f.jsx(Mo,{onToggle:b,setIsSuccessOpen:()=>u(m=>!m),exerciseInfo:l,setDairyProduct:c}),a&&f.jsx(zo,{onClose:()=>u(m=>!m),calories:s.calories})]})},No=E.div`
  display: flex;
  flex-direction: column;
  gap: 16px;
...
`,dt=E.span`
  color: ${n=>n.theme.colors.orangeColor};
`,Wo=()=>f.jsxs(No,{children:[f.jsxs(ct,{children:[f.jsx(dt,{children:"Sorry, no results were found "}),"for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),f.jsx(ct,{children:f.jsx(dt,{children:"Try changing the search parameters."})})]}),Go=E.div`
/* background-color: #040404; */
  margin-top: ${n=>n.theme.spacing(10)};
  margin-bottom: ${n=>n.theme.spacing(20)};

  @media screen and (min-width: 768px) {
    margin-top: ${n=>n.theme.spacing(18)};
    margin-bottom: ${n=>n.theme.spacing(12)};
  }
...
`,Xo=({children:n})=>f.jsx(Ko,{children:n}),ta=()=>{const n=ge(),e=Y(Ve),r=Y(ht);return p.useEffect(()=>{n(Jt()),n(pt()),n(Me())},[n]),f.jsx(Xo,{children:f.jsx(Go,{children:f.jsxs(Zt,{children:[f.jsxs(Yo,{children:[f.jsx(qo,{children:"Products"}),f.jsx(no,{})]}),r&&f.jsx(an,{}),e.length===0&&!r&&f.jsx(Wo,{}),e.length>0&&f.jsx(Uo,{})]})})})};export{ta as default};
