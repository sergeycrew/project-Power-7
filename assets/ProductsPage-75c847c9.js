...
`,_o=({calories:n,onClose:e})=>{const r=Y(cn);return h.jsx(Vo,{modalStyles:{maxWidth:"335px",width:"100%",height:"384px"},modalTabletStyles:{width:"430px",height:"439px"},modalDesktopStyles:{width:"430px",height:"439px"},onClose:e,children:h.jsxs(ko,{children:[h.jsx(Ro,{src:r,alt:"Category Image"}),h.jsxs($o,{children:[h.jsx(To,{children:"Well done"}),h.jsx("ul",{children:h.jsxs(Bo,{children:["Calories:",h.jsx(jo,{children:n||0})]})})]}),h.jsx(Lo,{onClick:e,children:"Next product "}),h.jsxs(Ho,{to:"/diary",children:["To the diary",h.jsx("svg",{width:" 16px",height:"16px",children:h.jsx("use",{href:`${ie}#arrow_gray`})})]})]})})},zo=()=>{const n=ge(),e=Y(Ve),r=Y(ht),[i,t]=p.useState(!1),[a,u]=p.useState(!1),[l,o]=p.useState(null),[s,c]=p.useState({calories:0}),d=Y(dn),g=Y(pn),v=()=>{n(Xt(1)),n(Me())},b=m=>{t(f=>!f),o(m)};return h.jsxs("div",{children:[h.jsxs(go,{children:[e.map(m=>h.jsx(vo,{children:h.jsx(mo,{product:m,toggleModal:b})},m._id)),!r&&d!==g&&h.jsx(on,{type:"button",onClick:()=>v(),children:"Load More"})]}),i&&h.jsx(Mo,{onToggle:b,setIsSuccessOpen:()=>u(m=>!m),exerciseInfo:l,setDairyProduct:c}),a&&h.jsx(_o,{onClose:()=>u(m=>!m),calories:s.calories})]})},Uo=E.div`
  display: flex;
  flex-direction: column;
  gap: 16px;
...
`,Ko=({children:n})=>h.jsx(qo,{children:n}),ea=()=>{const n=ge(),e=Y(Ve),r=Y(ht);return p.useEffect(()=>{n(Jt()),n(pt()),n(Me())},[n]),h.jsx(Ko,{children:h.jsx(Wo,{children:h.jsxs(Zt,{children:[h.jsxs(Go,{children:[h.jsx(Yo,{children:"Products"}),h.jsx(no,{})]}),r&&h.jsx(an,{}),e.length===0&&!r&&h.jsx(No,{}),e.length>0&&h.jsx(zo,{})]})})})};export{ea as default};
