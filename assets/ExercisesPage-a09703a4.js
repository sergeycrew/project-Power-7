import{u as i,F as R,a as T,c as v,j as e,H as J,I as P,r as c,J as X,K as Q,M as Z,x as $,s as S,N as ee,O as te,L as ie,P as ne,i as re,C as oe}from"./index-e10908c3.js";import{D as se}from"./DiaryLoader-780dbb56.js";import{e as ae}from"./UserForm.styled-9501dce5.js";import{i as F}from"./sprite-7ff823da.js";import{C as O}from"./CustomModal-eb679cc0.js";import"./formik.esm-60a6ec48.js";const le=i.div`
  max-width: 1440px;
  margin-bottom: 40px;
...
`,q=t=>t.exercises.loading,U=t=>t.exercises.filter,xe=t=>t.exercises.exercises,he=t=>t.exercises.categories,B=t=>t.exercises.categoryPicked,G=R([U,he,q],(t,n,o)=>{if(!o)return n.filter(r=>(r==null?void 0:r.filter)===t)}),V=t=>t.exercises.categoriesPage,K=t=>t.exercises.categoriesLimit,me=R([G,V,K],(t,n,o)=>{let r=[];return t.length>0&&(r=t.slice((n-1)*o,n*o)),r}),ge=R([G,K],(t,n)=>{let o=[];const r=Math.ceil(t.length/n);if(r>1){for(let a=1;a<=r;a++)o.push(a);return o}}),fe=()=>{const t=T(),n=v(U),o=v(B),r=a=>{t(J(a)),t(P(""))};return e.jsxs(le,{children:[o?e.jsx(ce,{children:o}):e.jsx(pe,{children:"Exercises"}),e.jsxs(de,{children:[e.jsx(I,{type:"button",onClick:()=>r("Body parts"),theme:{kostil:n==="Body parts"?void 0:"true"},children:"Body parts"}),e.jsx(I,{type:"button",onClick:()=>r("Muscles"),theme:{kostil:n==="Muscles"?void 0:"true"},children:"Muscles"}),e.jsx(I,{type:"button",onClick:()=>r("Equipment"),theme:{kostil:n==="Equipment"?void 0:"true"},children:"Equipment"})]})]})},ue=i.div`
padding-top: 40px;
padding-bottom: 80px;
...
`,Ee=i.p`
  ...
  font-weight: 400;
  line-height: 18px;
`,$e=({title:t,filter:n,photo:o})=>{const r=T(),[a,s]=c.useState(!1),[l,p]=c.useState(!1);c.useEffect(()=>{if(o){const h=new Image;h.src=o,h.onload=()=>{s(!0),p(!0)}}},[o]);const u=h=>{r(X(h)),r(P(h))};return e.jsx(ye,{onClick:()=>u(t),children:e.jsxs(ve,{children:[!o||!a?e.jsx(se,{}):e.jsx(je,{src:o||images,alt:t}),e.jsx(ke,{style:{visibility:l?"visible":"hidden"},children:e.jsxs(Ce,{children:[t,e.jsx(Ee,{children:n})]})})]})})},Te=({handleSetExName:t})=>{const n=T(),o=v(me),r=v(ge),a=v(V);return c.useEffect(()=>{n(Q())},[n]),e.jsxs("div",{children:[e.jsx(we,{children:o==null?void 0:o.map(s=>e.jsx($e,{handleSetExName:t,filter:s.filter,title:s.name,photo:s.imgURL},s._id))}),")",e.jsx(be,{children:r==null?void 0:r.map(s=>e.jsx(ae,{children:e.jsxs("div",{className:"radio",children:[e.jsx("input",{className:"radio-input",type:"radio",id:s,value:s,checked:a===s,onChange:()=>n(Z(s))}),e.jsx("label",{className:"radio-label",htmlFor:s})]})},s))})]})},ze=i.button`
background-color: inherit;
  display: inline-flex;
  align-items: center;
  gap: 4px;
