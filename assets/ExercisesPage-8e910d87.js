import{u as l,F as z,a as D,c as j,j as r,O as se,P as F,r as d,Q as q,R as ae,S as Y,T as le,U as ce,B as T,s as R,V as de,W as pe,L as he,X as ue,Y as fe,Z as xe,C as me}from"./index-a4373022.js";import{D as ge}from"./DiaryLoader-f15dcc77.js";import{e as we}from"./UserForm.styled-a2fc89db.js";import{T as ve,_ as $,C as X,a as ye,M as be,b as je,B as Ee}from"./ExercisesList.styled-3eda1afa.js";import{i as I}from"./sprite-1f3cbb54.js";import"./formik.esm-a20d9443.js";const Se=l.div`
  max-width: 1440px;
  margin-bottom: 40px;
...
`,At=({card:t,toogleModal:i})=>r.jsxs(Mt,{children:[r.jsxs(Rt,{children:[r.jsx(It,{children:"WORKOUT"}),r.jsxs(ue,{style:{display:"flex",alignItems:"center"},onClick:()=>i(t),children:[r.jsx(Wt,{children:"Start"}),r.jsx(Yt,{children:r.jsxs("svg",{fill:"#efede8",children:[" ",r.jsx("use",{href:I+"#icon-arrow-right"})]})})]})]}),r.jsxs(zt,{children:[r.jsx(Bt,{children:r.jsx("svg",{children:r.jsx("use",{href:`${I}#icon-run-exercises`})})}),r.jsx(Ft,{children:t.name})]}),r.jsxs(Ot,{children:[r.jsxs("li",{children:["Burned calories:",r.jsx("span",{children:t.burnedCalories})]}),r.jsxs("li",{children:["Body part: ",r.jsx("span",{children:t.bodyPart})]}),r.jsxs("li",{children:["Target:",r.jsx("span",{children:t.target})]})]})]},t._id);/*! *****************************************************************************
