import{u as s,L as b,r as j,a as $,j as i,s as n,l as v}from"./index-6736019d.js";import{F as S,a as k,b as C}from"./formik.esm-6499bbb7.js";import{c as z,a as c}from"./index.esm-aab25243.js";import{H as P,M as y,a as I}from"./WelcomePage.styled-5d23942b.js";const F=s.h1`
  font-weight: 700;
  font-size: 24px;
  line-height: 1.17;
...
`,T=/^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/,A=z().shape({email:c().trim().matches(T,"Please enter a valid email! For example jane@mail.com").required("Email is required"),password:c().trim().min(6,"Password must be at least 6 characters.").max(30,"Password should not exceed 30 characters").matches(/^\S*$/,"Password should not contain spaces").required("Password is required")}),D={email:"",password:""},H=()=>{const[e,g]=j.useState(!1),u=$(),r=i.jsx(d,{children:i.jsx("use",{href:`${n}#success`})}),l=i.jsx(d,{children:i.jsx("use",{href:`${n}#not-success`})}),w=({email:o,password:t},{resetForm:f})=>{u(v({email:o,password:t})),f()};return i.jsx(C,{initialValues:D,onSubmit:w,validationSchema:A,children:({errors:o,touched:t})=>i.jsxs(B,{noValidate:!0,children:[i.jsxs(E,{children:[i.jsxs(h,{children:[i.jsx(p,{autoComplete:"on",type:"email",id:"email",name:"email",placeholder:"Email",required:!0,className:t.email&&o.email?"invalid":t.email&&!o.email?"valid":""}),t.email&&(o.email||!o.email)&&i.jsxs(m,{children:[o.email&&i.jsxs(a,{className:"error",children:[l," ",o.email]}),!o.email&&i.jsxs(a,{className:"success",children:[r," Success email"]})]})]}),i.jsxs(h,{children:[i.jsx(p,{type:e?"text":"password",id:"password",name:"password",placeholder:"Password",required:!0,className:t.password&&o.password?"invalid":t.password&&!o.password?"valid":""}),i.jsx(M,{type:"button",onClick:()=>{g(!e)},children:e?i.jsx(x,{children:i.jsx("use",{href:`${n}#eye`})}):i.jsx(x,{children:i.jsx("use",{href:`${n}#eye-off`})})}),t.password&&(o.password||!o.password)&&i.jsxs(m,{children:[o.password&&i.jsxs(a,{className:"error",children:[l," ",o.password]}),!o.password&&i.jsxs(a,{className:"success",children:[r," Success password"]})]})]})]}),i.jsx(W,{type:"submit",children:"Sign In"})]})})},G=()=>i.jsx(P,{children:i.jsx(y,{children:i.jsxs(I,{children:[i.jsx(F,{children:"Sign In"}),i.jsx(L,{children:"Welcome! Please enter your credentials to login to the platform:"}),i.jsx(H,{}),i.jsxs(V,{children:[i.jsx(q,{children:"Don’t have an account? "}),i.jsx(N,{to:"/signUp",children:"Sign Up"})]})]})})});export{G as default};
