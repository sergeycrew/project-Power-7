...
`,qo=({children:n})=>h.jsx(Xo,{children:n}),ea=()=>{const n=ge(),e=Y(Ve),r=Y(ht);return p.useEffect(()=>{n(Jt()),n(pt()),n(Me())},[n]),h.jsx(Zt,{children:h.jsxs(qo,{children:[h.jsxs(Wo,{children:[h.jsxs(Go,{children:[h.jsx(Yo,{children:"Products"}),h.jsx(no,{})]}),r&&h.jsx(an,{positionPc:{transform:"translateX(-16%)"}}),e.length===0&&!r&&h.jsx(No,{}),e.length>0&&h.jsx(zo,{})]})," "]})})};export{ea as default};
