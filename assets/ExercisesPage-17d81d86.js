import{u as a,F,a as D,c as j,j as r,M as se,N as B,r as d,O as q,R as ae,P as W,Q as le,S as ce,B as S,s as M,T as de,U as pe,L as he,V as ue,W as fe,X as xe,C as me}from"./index-6736019d.js";import{D as ge}from"./DiaryLoader-257de575.js";import{e as we}from"./UserForm.styled-016f5526.js";import{T as be,_ as $,C as X}from"./CustomModal-83cbabcb.js";import{i as z}from"./sprite-72b2faa7.js";import"./formik.esm-6499bbb7.js";const ye=a.div`
  max-width: 1440px;
  margin-bottom: 40px;
...
`,Oe=a.p`
  ...
  font-weight: 400;
  line-height: 18px;
`,We=({title:t,filter:i,photo:n})=>{const e=D(),[o,s]=d.useState(!1),[l,c]=d.useState(!1);d.useEffect(()=>{if(n){const p=new Image;p.src=n,p.onload=()=>{s(!0),c(!0)}}},[n]);const h=p=>{e(q(p)),e(B(p))};return r.jsx(Me,{onClick:()=>h(t),children:r.jsxs(Ie,{children:[!n||!o?r.jsx(ge,{}):r.jsx(ze,{src:n||images,alt:t}),r.jsx(Fe,{style:{visibility:l?"visible":"hidden"},children:r.jsxs(Be,{children:[t,r.jsx(Oe,{children:i})]})})]})})};function Ye(t){return Object.keys(t).length===0}function Ae(t=null){const i=d.useContext(be);return!i||Ye(i)?t:i}function ne(t,i){const n=$({},i);return Object.keys(t).forEach(e=>{if(e.toString().match(/^(components|slots)$/))n[e]=$({},t[e],n[e]);else if(e.toString().match(/^(componentsProps|slotProps)$/)){const o=t[e]||{},s=i[e];n[e]={},!s||!Object.keys(s)?n[e]=o:!o||!Object.keys(o)?n[e]=s:(n[e]=$({},s),Object.keys(o).forEach(l=>{n[e][l]=ne(o[l],s[l])}))}else n[e]===void 0&&(n[e]=t[e])}),n}function Ue(t){const{theme:i,name:n,props:e}=t;return!i||!i.components||!i.components[n]||!i.components[n].defaultProps?e:ne(i.components[n].defaultProps,e)}const He=typeof window<"u"?d.useLayoutEffect:d.useEffect,Qe=He;function Ve(t,i,n,e,o){const[s,l]=d.useState(()=>o&&n?n(t).matches:e?e(t).matches:i);return Qe(()=>{let c=!0;if(!n)return;const h=n(t),p=()=>{c&&l(h.matches)};return p(),h.addListener(p),()=>{c=!1,h.removeListener(p)}},[t,n]),s}const ie=ae["useSyncExternalStore"];function Ne(t,i,n,e,o){const s=d.useCallback(()=>i,[i]),l=d.useMemo(()=>{if(o&&n)return()=>n(t).matches;if(e!==null){const{matches:x}=e(t);return()=>x}return s},[s,t,e,o,n]),[c,h]=d.useMemo(()=>{if(n===null)return[s,()=>()=>{}];const x=n(t);return[()=>x.matches,u=>(x.addListener(u),()=>{x.removeListener(u)})]},[s,n,t]);return ie(h,c,l)}function Ge(t,i={}){const n=Ae(),e=typeof window<"u"&&typeof window.matchMedia<"u",{defaultMatches:o=!1,matchMedia:s=e?window.matchMedia:null,ssrMatchMedia:l=null,noSsr:c=!1}=Ue({name:"MuiUseMediaQuery",props:i,theme:n});let h=typeof t=="function"?t(n):t;return h=h.replace(/^@media( ?)/m,""),(ie!==void 0?Ne:Ve)(h,o,s,l,c)}const qe=({handleSetExName:t})=>{const i=D(),n=j(Le),e=j(De),o=j(ee),s=Ge("(min-width: 768px) and (max-width: 1440px)");return d.useEffect(()=>{i(s?W(9):W(10))},[i,s]),d.useEffect(()=>{i(le())},[i]),r.jsxs("div",{children:[r.jsx($e,{children:n==null?void 0:n.map(l=>r.jsx(We,{handleSetExName:t,filter:l.filter,title:l.name,photo:l.imgURL},l._id))}),")",r.jsx(Re,{children:e==null?void 0:e.map(l=>r.jsx(we,{children:r.jsxs("div",{className:"radio",children:[r.jsx("input",{className:"radio-input",type:"radio",id:l,value:l,checked:o===l,onChange:()=>i(ce(l))}),r.jsx("label",{className:"radio-label",htmlFor:l})]})},l))})]})},Xe=a.button`
background-color: inherit;
  display: inline-flex;
  align-items: center;
  gap: 4px;
...
`,At=({card:t,toogleModal:i})=>r.jsxs(Rt,{children:[r.jsxs(Mt,{children:[r.jsx(zt,{children:"WORKOUT"}),r.jsxs(ue,{style:{display:"flex",alignItems:"center"},onClick:()=>i(t),children:[r.jsx(Yt,{children:"Start"}),r.jsx(Wt,{children:r.jsxs("svg",{fill:"#efede8",children:[" ",r.jsx("use",{href:z+"#icon-arrow-right"})]})})]})]}),r.jsxs(Ft,{children:[r.jsx(It,{children:r.jsx("svg",{children:r.jsx("use",{href:`${z}#icon-run-exercises`})})}),r.jsx(Bt,{children:t.name})]}),r.jsxs(Ot,{children:[r.jsxs("li",{children:["Burned calories:",r.jsx("span",{children:t.burnedCalories})]}),r.jsxs("li",{children:["Body part: ",r.jsx("span",{children:t.bodyPart})]}),r.jsxs("li",{children:["Target:",r.jsx("span",{children:t.target})]})]})]},t._id);/*! *****************************************************************************
...
***************************************************************************** */var I=function(t,i){return I=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(n,e){n.__proto__=e}||function(n,e){for(var o in e)e.hasOwnProperty(o)&&(n[o]=e[o])},I(t,i)};function Ut(t,i){I(t,i);function n(){this.constructor=t}t.prototype=i===null?Object.create(i):(n.prototype=i.prototype,new n)}var L=function(){return L=Object.assign||function(i){for(var n,e=1,o=arguments.length;e<o;e++){n=arguments[e];for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&(i[s]=n[s])}return i},L.apply(this,arguments)};function Ht(t,i,n,e){var o,s=!1,l=0;function c(){o&&clearTimeout(o)}function h(){c(),s=!0}typeof i!="boolean"&&(e=n,n=i,i=void 0);function p(){var x=this,u=Date.now()-l,m=arguments;if(s)return;function b(){l=Date.now(),n.apply(x,m)}function v(){o=void 0}e&&!o&&b(),c(),e===void 0&&u>t?b():i!==!0&&(o=setTimeout(e?v:b,e===void 0?t-u:t))}return p.cancel=h,p}var C={Pixel:"Pixel",Percent:"Percent"},N={unit:C.Percent,value:.8};function G(t){return typeof t=="number"?{unit:C.Percent,value:t*100}:typeof t=="string"?t.match(/^(\d*(\.\d+)?)px$/)?{unit:C.Pixel,value:parseFloat(t)}:t.match(/^(\d*(\.\d+)?)%$/)?{unit:C.Percent,value:parseFloat(t)}:(console.warn('scrollThreshold format is invalid. Valid formats: "120px", "50%"...'),N):(console.warn("scrollThreshold should be string or number"),N)}(function(t){Ut(i,t);function i(n){var e=t.call(this,n)||this;return e.lastScrollTop=0,e.actionTriggered=!1,e.startY=0,e.currentY=0,e.dragging=!1,e.maxPullDownDistance=0,e.getScrollableTarget=function(){return e.props.scrollableTarget instanceof HTMLElement?e.props.scrollableTarget:typeof e.props.scrollableTarget=="string"?document.getElementById(e.props.scrollableTarget):(e.props.scrollableTarget===null&&console.warn(`You are trying to pass scrollableTarget but it is null. This might
  ...
  @media (min-width: 1440px) {
    ...
    background-image: ${t=>t.theme.activeCategory?`image-set(url(${Vt}) 1x, url(${Nt}) 2x)`:"none"};
  }
