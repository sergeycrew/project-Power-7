import bg_mob_1x from '../images/mobileImages/bg-mobile-1x.png';
import bg_mob_2x from '../images/mobileImages/bg-mobile-2x.png';
import bg_tab_1x from '../images/tabletImages/hero-tablet-1x.png';
